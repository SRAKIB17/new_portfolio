  ...
  return (
    <main>
      ...
      <div className="flex flex-col items-center justify-center relative pb-40">
        <img alt="hero image"
          src="https://images.unsplash.com/photo-1498049860654-af1a5c566876?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1050&q=80" width={250} height={250}
        ...
        <a href="/images/cv.pdf" download
          className="btn bg-primary-gradient" style={{ borderRadius: "9999px" }}>
          <img
